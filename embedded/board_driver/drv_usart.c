...
#define USART1_CLK_ENABLE()              __USART3_CLK_ENABLE()
#define USART1_RX_GPIO_CLK_ENABLE()      __GPIOD_CLK_ENABLE()
#define USART1_TX_GPIO_CLK_ENABLE()      __GPIOD_CLK_ENABLE()

#define USART1_FORCE_RESET()             __USART3_FORCE_RESET()
#define USART1_RELEASE_RESET()           __USART3_RELEASE_RESET()

/* Definition for USARTx Pins */
#define USART1_TX_PIN                    GPIO_PIN_9
#define USART1_TX_GPIO_PORT              GPIOD
#define USART1_TX_AF                     GPIO_AF7_USART3
#define USART1_RX_PIN                    GPIO_PIN_8
#define USART1_RX_GPIO_PORT              GPIOD
#define USART1_RX_AF                     GPIO_AF7_USART3
...
/**
  ...
  * @retval None
  */
void HAL_UART_MspInit_by_cubemx(UART_HandleTypeDef *huart)
{
...
/**
  ...
  * @retval None
  */
void HAL_UART_MspDeInit_by_cubemx(UART_HandleTypeDef *huart)
{
    if (huart->Instance == USART1)
    {
        /* Reset peripherals */
